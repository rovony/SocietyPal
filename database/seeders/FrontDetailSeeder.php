    ...
    public function run(): void
    {
        ...
        foreach ($activeLanguages as $languageSetting) {
            ...
            FrontDetail::create([
                ...
                'header_title' => 'Simplify Society Management with Our SaaS Solution',
                'header_description' => 'An all-in-one platform to efficiently manage apartments, residents and maintenance. Reduce administrative burden while improving operational efficiency.',
                'image' => null ,
                'feature_with_image_heading' => 'Streamline Your Society Operations',
                'feature_with_icon_heading' => 'Advanced Features to Transform Your Society Management',
                'review_heading' => 'Success Stories from Society Administrators',
                'price_heading' => 'Straightforward Pricing Plans',
                'price_description' => 'One comprehensive plan with all essential features at an affordable price.',
                'faq_heading' => 'Common Questions Answered',
                'faq_description' => 'Answers to the most frequently asked questions.',
                'contact_heading' => 'Contact',
                'footer_copyright_text' => '© 2025 SocietyPro. All Rights Reserved.',
                'created_at' => now(),
                'updated_at' => now(),
            ]);
