...
class PackageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $subscriptionPackage->additional_features = json_encode(Package::ADDITIONAL_FEATURES);
        ...
        $lifetimePackage->package_name = 'Lifetime Access';
        ...
        $privatePackage->additional_features = json_encode(Package::ADDITIONAL_FEATURES);
