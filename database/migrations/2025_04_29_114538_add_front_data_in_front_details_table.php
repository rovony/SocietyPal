    ...
    public function up(): void
    {
        ...
        foreach ($activeLanguages as $languageSetting) {
            ...
            FrontDetail::create([
                ...
                'header_title' => Lang::get('landing.heroTitle', [], $languageSetting->language_code),
                'header_description' => Lang::get('landing.heroSubTitle', [], $languageSetting->language_code),
                'image' => null,
                'feature_with_image_heading' => Lang::get('landing.featureSection1', [], $languageSetting->language_code),
                'feature_with_icon_heading' =>  Lang::get('landing.featureSection2', [], $languageSetting->language_code),
                'review_heading' => Lang::get('landing.testimonialSection1', [], $languageSetting->language_code),
                'price_heading' => Lang::get('landing.pricingTitle1', [], $languageSetting->language_code),
                'price_description' => Lang::get('landing.pricingSubTitle1', [], $languageSetting->language_code),
                'faq_heading' => Lang::get('landing.faqTitle1', [], $languageSetting->language_code),
                'faq_description' => Lang::get('landing.faqSubTitle1', [], $languageSetting->language_code),
                'contact_heading' =>  Lang::get('landing.contactTitle', [], $languageSetting->language_code),
                'footer_copyright_text' => Lang::get('landing.rightsReserved', [], $languageSetting->language_code),
                'created_at' => now(),
                'updated_at' => now(),
            ]);
            ...
            $features = [
                [
                    'description' => Lang::get('landing.featureDescription1', [], $languageSetting->language_code),
                    'icon' => '',
                    'image' => null,
                    'language_setting_id' => $languageSetting->id,
                    'title' => Lang::get('landing.featureTitle1', [], $languageSetting->language_code),
                    'type' => 'image',
                ],
                [
                    'language_setting_id' => $languageSetting->id,
                    'title' => Lang::get('landing.featureTitle2', [], $languageSetting->language_code),
                    'description' => Lang::get('landing.featureDescription2', [], $languageSetting->language_code),
                    'type' => 'image',
                    'icon' => '',
                    'image'=> null,
                ],
                [
                    'language_setting_id' => $languageSetting->id,
                    'title' => Lang::get('landing.featureTitle3', [], $languageSetting->language_code),
                    'description' => Lang::get('landing.featureDescription3', [], $languageSetting->language_code),
                    'type' => 'image',
                    'icon' => '',
                    'image'=> null,
                ],
                [
                    'description' => Lang::get('landing.iconFeatureDesc1', [], $languageSetting->language_code),
                    ...
                    'language_setting_id' => $languageSetting->id,
                    'type' => 'icon',
                    'title' => Lang::get('landing.iconFeature1', [], $languageSetting->language_code),
                ],

                [
                    'description' => Lang::get('landing.iconFeatureDesc2', [], $languageSetting->language_code),
                    'language_setting_id' => $languageSetting->id,
                    'title' => Lang::get('landing.iconFeature2', [], $languageSetting->language_code),
                ...
                [
                'description' => Lang::get('landing.iconFeatureDesc3', [], $languageSetting->language_code),
                'language_setting_id' => $languageSetting->id,
                'title' => Lang::get('landing.iconFeature3', [], $languageSetting->language_code),
                'type' => 'icon',
                'image' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-qr-code-scan text-skin-base dark:text-skin-base size-6" viewBox="0 0 16 16">
                ...
                [
                'description' => Lang::get('landing.iconFeatureDesc4', [], $languageSetting->language_code),
                ...
                'icon' => 'print-icon',
                'language_setting_id' => $languageSetting->id,
                'title' => Lang::get('landing.iconFeature4', [], $languageSetting->language_code),
                'type' => 'icon',
            ],


            [
                'description' => Lang::get('landing.iconFeatureDesc5', [], $languageSetting->language_code),
                'image' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-qr-code-scan text-skin-base dark:text-skin-base size-6" viewBox="0 0 16 16">
                ...
                'icon' => 'bi-box',
                'language_setting_id' => $languageSetting->id,
                'title' => Lang::get('landing.iconFeature5', [], $languageSetting->language_code),
                'type' => 'icon',
            ],
            [
                'description' => Lang::get('landing.iconFeatureDesc6', [], $languageSetting->language_code),
                'image' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                'language_setting_id' => $languageSetting->id,
                'title' => Lang::get('landing.iconFeature6', [], $languageSetting->language_code),
                'type' => 'icon',
            ],
            [
                'description' => Lang::get('landing.iconFeatureDesc7', [], $languageSetting->language_code),
                ...
                'language_setting_id' => $languageSetting->id,
                'title' => Lang::get('landing.iconFeature7', [], $languageSetting->language_code),
                'icon' => null,
                  'type' => 'icon',
            ],
            [
            'description' => Lang::get('landing.iconFeatureDesc8', [], $languageSetting->language_code),
            'language_setting_id' => $languageSetting->id,
            'title' => Lang::get('landing.iconFeature8', [], $languageSetting->language_code),
            'image' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-qr-code-scan text-skin-base dark:text-skin-base size-6" viewBox="0 0 16 16">
            ...
            DB::table('front_features')->insert($features);

            // Insert data into FrontReviewSetting
            FrontReviewSetting::insert([
                [
                    'language_setting_id' => $languageSetting->id,
                    'reviewer_name' => Lang::get('landing.testimonialName1', [], $languageSetting->language_code),
                    'reviewer_designation' => Lang::get('landing.testimonialDesignation1', [], $languageSetting->language_code),
                    'reviews' => Lang::get('landing.testimonial1', [], $languageSetting->language_code),
                ],
                [
                    'language_setting_id' => $languageSetting->id,
                    'reviewer_name' => Lang::get('landing.testimonialName2', [], $languageSetting->language_code),
                    'reviewer_designation' => Lang::get('landing.testimonialDesignation2', [], $languageSetting->language_code),
                    'reviews' => Lang::get('landing.testimonial2', [], $languageSetting->language_code),
                ],
            ]);
            ...
            FrontFaq::insert([
                [
                    'language_setting_id' => $languageSetting->id,
                    'question' => Lang::get('landing.faqQues1', [], $languageSetting->language_code),
                    'answer' => Lang::get('landing.faqAns1', [], $languageSetting->language_code),
                ],
                [
                    'language_setting_id' => $languageSetting->id,
                    'question' => Lang::get('landing.faqQues2', [], $languageSetting->language_code),
                    'answer' => Lang::get('landing.faqAns2', [], $languageSetting->language_code),
                ],
            ]);
            ...
            Contact::create([
                'language_setting_id' => $languageSetting->id,
                'contact_company' => Lang::get('landing.contactCompany', [], $languageSetting->language_code),
                'address' => Lang::get('landing.contactAddress', [], $languageSetting->language_code),
                'email' => Lang::get('landing.contactEmail', [], $languageSetting->language_code),
                'created_at' => now(),
                'updated_at' => now(),
            ]);
        }
