...
/**
 * Get required fields for a specific step (made more flexible for testing)
 * @param {number} stepNumber - Step number
 * @returns {string[]} Array of field IDs
 */
function getRequiredFieldsForStep(stepNumber) {
    const stepFields = {
        1: ["projectName"], // Only require project name for step 1
        2: ["serverHost"], // Only require server host for step 2
        3: [], // No strict requirements for step 3 during testing
        4: [], // No strict requirements for step 4 during testing
        5: [], // No strict requirements for step 5 during testing
        6: [],
        7: [],
    };
