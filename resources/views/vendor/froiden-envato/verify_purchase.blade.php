...
<html>
<head>
    <title>Society Pro - Verify Purchase</title>
    ...
    <div class="container mx-auto px-4 py-6 max-w-2xl">
        <div class="flex flex-col items-center mb-12">
            <div class="flex items-center">
                    <img src="{{ asset('img/logo.png') }}" class="h-12 w-auto" alt="Society Pro Logo"/>
                <h1 class="text-2xl font-bold ml-4 text-gray-800">Society Pro Saas</h1>
            </div>
        </div>
