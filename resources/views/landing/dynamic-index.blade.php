...
@section('content')
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
            ...
            <div
                class="flex flex-col mb-8 space-y-4 lg:mb-16 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
            ...
            <div class="relative flex justify-center max-w-screen-lg mx-auto">
                @if(!empty($frontDetails->image))
                <div>
                        <img src="{{  $frontDetails->image_url }}" class="border rounded-lg shadow-lg " alt="">
                </div>
                @else
                    <img src="{{ asset('landing/dashboard.png') }}" class="border rounded-lg shadow-lg " alt="">
        ...
        @if (!$frontFeatures->isEmpty() )
            @foreach($frontFeatures as $index => $feature)
                @if ($feature->type == 'image')
                    ...
                    <div class="mb-10 md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
                        @if($index % 2 == 0)
                                    <div class="w-[500px] h-[500px] overflow-hidden rounded-xl border border-gray-100 shadow">
                                        <img class="object-cover object-center w-full h-full"
                                src="{{ empty($feature->image) || $feature->image === 'null' ? asset('landing/tenant.png') :  $feature->image_url }}"
                                        alt="{{ $feature->title }}">
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <!-- End Col -->
                                @else
                                    <div class="order-2 mt-5 md:order-1 sm:mt-10 lg:mt-0">
                                        <div class="space-y-6 sm:space-y-8">
                                            <!-- Title -->
                                            <div class="space-y-2 md:space-y-4">
                                                <h2 class="text-3xl font-bold text-gray-800 lg:text-4xl dark:text-neutral-200">
                                    ...
                                    <div class="w-[500px] h-[500px] overflow-hidden rounded-xl border border-gray-100 shadow order-1 md:order-2">
                                        <img class="object-cover object-center w-full h-full"
                                    src="{{ empty($feature->image) || $feature->image === 'null' ? asset('landing/service-provider.png') : $feature->image_url }}"
                                            alt="{{ $feature->title }}">
                                    </div>
                                    <!-- End Col -->
                ...
                @else
                    ...
                    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
                        ...
                        <!-- End Col -->
                        <div>
                    <img class="border border-gray-100 shadow rounded-xl" src="{{ asset('landing/service-provider.png') }}"
                    ...
                    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
                        <div>
                    <img class="border border-gray-100 shadow rounded-xl" src="{{ asset('landing/book-amenity.png') }}"
                                alt="order management">
                        </div>
                <!-- End Col -->
        ...
        @else
            <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    <div
                        class="relative flex justify-center items-center size-12 bg-white rounded-xl before:absolute before:-inset-px before:-z-[1] before:bg-gradient-to-br before:from-gray-700 before:via-transparent before:to-gray-600 before:rounded-xl dark:bg-neutral-900">
                        <svg class="transition duration-75 size-6 text-skin-base dark:text-skin-base" fill="currentColor"
    ...
    <div class="px-4 py-12 mx-auto max-w-7xl lg:px-8 lg:py-24">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:items-center md:gap-8 lg:gap-12">
            ...
            @if(!empty($frontContact->image))
                <img class="object-cover w-full h-screen transition-transform duration-500 ease-in-out group-hover:scale-105 group-focus:scale-105 rounded-2xl"
                style="max-height: fit-content"

                    src="{{$frontContact->image_url }}"
                    alt="Contact Image">
            @else
                <img class="object-cover transition-transform duration-500 ease-in-out group-hover:scale-105 group-focus:scale-105 rounded-2xl"
                ...
                <div>
                    ...
                    <div class="grid gap-4 sm:gap-6 md:gap-8 lg:gap-12">
                        <div class="flex gap-4">
                            <svg class="text-gray-500 shrink-0 size-5 dark:text-neutral-500"
