...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto space-y-8">
    ...
    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
        <div>
            <img class="rounded-xl border border-gray-100 shadow" src="{{ asset('landing/tenant.png') }}"
    ...
    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
        ...
        <!-- End Col -->
        <div>
            <img class="rounded-xl border border-gray-100 shadow" src="{{ asset('landing/service-provider.png') }}"
                alt="service provider management">
        </div>
        <!-- End Col -->
    ...
    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
        <div>
            <img class="rounded-xl border border-gray-100 shadow" src="{{ asset('landing/book-amenity.png') }}"
                alt="book amenity management">
        </div>
        <!-- End Col -->
