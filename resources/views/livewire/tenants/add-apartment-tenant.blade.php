<div>
    <form wire:submit="addApartment">
        ...
        <div class="space-y-4">
            <div>
                <x-search-dropdown id="apartment_id" label="Apartment Number" model="apartment_id" :options="$apartmentRented->map(fn($a) => ['id' => $a->id, 'number' => $a->apartment_number])" placeholder="Select Apartment Number" :required="true"/>
            </div>
