            ...
            <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div class="flex items-start space-x-4">
                    ...
                    <div class="w-1/2">
                        ...
                        <input class="block w-full text-sm border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 text-slate-500 mt-1" accept="image/png, image/gif, image/jpeg, image/webp, application/pdf" type="file" wire:model="documentFile">
