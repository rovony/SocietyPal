                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        @forelse ($frontDetails as $feature)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 even:bg-gray-50 dark:even:bg-gray-700" wire:key='feature-{{ $feature->id . microtime() }}'>
                                ...
                                <td class="px-4 py-3 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                    <img src="{{ $feature->image_url }}" alt="Feature Image" class="object-cover w-16 h-16 rounded">
                                </td>
                                 <td class="px-4 py-3 text-base text-gray-900 whitespace-nowrap dark:text-white">
        ...
        <x-right-modal wire:model.live="addFeatureModal">
            ...
            <x-slot name="content">
                <form wire:submit.prevent="saveFeature">
                    ...
                    @if ($existingImageUrl)
                        <div class="mt-4">
                            <img src="{{ $existingImageUrl }}" alt="Current Image" class="object-cover w-32 h-32 rounded">
                        </div>
                    @endif
