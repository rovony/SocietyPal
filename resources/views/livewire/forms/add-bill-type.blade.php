<div>
    <form wire:submit="submitForm">
        ...
        <div class="space-y-4">
            ...
            <div>
                <x-label for="billTypeName" value="{{ __('modules.settings.addBillType') }}" required="true" />
                <x-input id="billTypeName" class="block w-full mt-1" type="text" autofocus wire:model='billTypeName' />
        ...
        <div class="flex w-full pb-4 mt-6 space-x-4">
            ...
            <x-button-cancel  wire:click="$dispatch('hideAddBillType')" wire:loading.attr="disabled">@lang('app.cancel')</x-button-cancel>
