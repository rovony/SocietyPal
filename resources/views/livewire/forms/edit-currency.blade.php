<div>
    <form wire:submit="submitForm">
        ...
        <div class="space-y-4">
            ...
            <div>
                <x-label for="currencyName" value="{{ __('modules.settings.societyCurrency') }}" required="true" />
                <x-input id="currencyName" class="block mt-1 w-full" type="text" autofocus wire:model.live='currencyName' />
                <x-input-error for="currencyName" class="mt-2" />
            </div>

            <div>
                <x-label for="currencySymbol" value="{{ __('modules.settings.currencySymbol') }}" required="true"/>
                <x-input id="currencySymbol" class="block mt-1 w-full" type="text" autofocus wire:model.live='currencySymbol' required="true" />
                <x-input-error for="currencySymbol" class="mt-2" />
            </div>

            <div>
                <x-label for="currencyCode" value="{{ __('modules.settings.currencyCode') }}" />
                <x-input id="currencyCode" class="block mt-1 w-full" type="text" autofocus wire:model.live='currencyCode' required="true" />
        ...
        <div class="mt-4 bg-gray-100 p-4 rounded-md font-medium text-gray-800">
