<div>
    <form wire:submit="SubmitForm">
        ...
        <div class="space-y-4">
            <div>
                <x-label for="service_management_id" value="{{ __('modules.serviceManagement.servicePerson') }}" required/>
                <x-select  class="mt-1 block w-full" wire:model.live='service_management_id'>
                    <option value="">@lang('modules.settings.serviceUsers')</option>
            ...
            <div class="flex space-x-4">
                <div class="w-1/2">
                    <x-label for="clock_out_date" value="{{ __('modules.serviceManagement.clockOutDate') }}"/>
                    <x-datepicker class="block w-full mt-1" wire:model.live="clock_out_date" id="clock_out_date" autocomplete="off" placeholder="{{ __('modules.serviceManagement.clockOutDate') }}"/>
                    <x-input-error for="clock_out_date" class="mt-2" />
                </div>
                <div class="w-1/2">
                    <x-label for="clock_out_time" value="{{ __('modules.serviceManagement.clockOutTime') }}"/>
                    <div class="relative mt-1">
                        <div class="absolute inset-y-0 end-0 top-0 flex items-center pe-3.5 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4a1 1 0 1 0-2 0v4a1 1 0 0 0 .293.707l3 3a1 1 0 0 0 1.414-1.414L13 11.586V8Z" clip-rule="evenodd"/>
                        ...
                        <input type="time" id="clock_out_time" wire:model.live='clock_out_time' class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500" min="00:00" max="23:59" value="00:00" />
                    </div>
