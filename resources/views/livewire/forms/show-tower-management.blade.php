    ...
    <div class="p-4 bg-white col-span-full xl:mb-2 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
        <nav class="flex items-center" aria-label="Breadcrumb">
            ...
            <li>
                ...
                <a href="{{ route('towers.index') }}" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">@lang('menu.towerManagment')</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">@lang('modules.settings.towerDetails')</span>
                </div>
            </li>
            </ol>
        </nav>
    ...
    <div class="items-center justify-between block p-4 bg-white sm:flex dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">
                @lang('modules.settings.towerDetails')</h1>

        </div>
    </div>
    <div class="grid gap-3 px-5 mt-3 sm:grid-cols-2 lg:grid-cols-4 sm:gap-5">
        ...
        <div class="p-3 group flex flex-col border border-gray-200 dark:border-gray-700 shadow-sm rounded-lg hover:shadow-md transition bg-white dark:bg-gray-800">
            <div class="flex items-center">
                <div class="p-2 bg-gray-100 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="w-4 h-4 text-gray-500 dark:text-black" viewBox="0 0 16 16">
                ...
                <div class="grow ms-5">
                    <h3 wire:loading.class.delay='opacity-50'
                        ...
                        @lang('modules.settings.totalFloor')
                    </h3>
                    <p @class(['text-sm dark:text-neutral-200'])>{{ $tower->floors->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-3 group flex flex-col border border-gray-200 dark:border-gray-700 shadow-sm rounded-lg hover:shadow-md transition bg-white dark:bg-gray-800">
            <div class="flex items-center">
                ...
                <div class="grow ms-5">
                    ...
                    <p @class(['text-sm dark:text-neutral-200'])>{{ $tower->apartmentManagement->count() }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="grid m-5 lg:grid-cols-1 lg:gap-5 dark:bg-gray-900">
        <div
            ...
            <div class="flex items-center space-x-4 sm:space-x-4">
                <div class="p-2 bg-gray-100 rounded-md">
                    <svg class="w-10 h-10 text-gray-500 dark:text-black" viewBox="0 0 25 25" fill="none" width="24" height="24" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <h1 class="mb-1 text-xl font-bold text-gray-900 dark:text-white">@lang('modules.settings.towerName') {{ $tower->tower_name }}
                    </h1>
                </div>
        ...
        <div class="relative overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" wire:key='member-list-{{ microtime() }}'>
                    ...
                    @forelse ($tower->apartmentManagement as $item)
