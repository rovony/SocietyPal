<div>
    <form wire:submit="submitForm">
        ...
        <div class="space-y-4">
            ...
            <div>
                <x-label for="currencyCode" value="{{ __('modules.settings.currencyCode') }}" required="true" />
                <x-input id="currencyCode" class="block mt-1 w-full" type="text" autofocus wire:model.live='currencyCode' />
