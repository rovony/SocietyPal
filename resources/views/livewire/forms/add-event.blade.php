    ...
    <form wire:submit="submitForm">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <x-select  class="mt-1 block w-full" wire:model.live='status'>
                    <option value="">@lang('modules.settings.status')</option>
            ...
            <div class="flex w-full pb-4 space-x-4 mt-6">
                ...
                <x-button-cancel  wire:click="$dispatch('hideAddEvent')" wire:loading.attr="disabled">@lang('app.cancel')</x-button-cancel>
            </div>
        </div>
    </form>
</div>
