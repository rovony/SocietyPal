<div x-data="{ activeTab: @entangle('activeSetting') }" class="mx-4">
    ...
    <!-- Tabs Navigation -->
    <div class="flex flex-wrap mb-4 border-b border-gray-200 dark:border-gray-700">
        <button @click="activeTab = 'settings'; $wire.set('activeSetting', 'settings')"
            ...
            class="px-6 py-4 text-sm transition-colors duration-200 focus:outline-none">
    ...
    <div x-show="activeTab === 'settings'"
        class="p-4 mt-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <form wire:submit="submitForm">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6">
                    ...
                    <div class="p-4 space-y-4 border rounded-lg dark:border-gray-500">
                    <div>
                    ...
                    @if (!$disableLandingSite)
                        <div>
                            ...
                            <x-select id="landingSiteType" class="block w-full mt-1" wire:model.live="landingSiteType">
                        ...
                        @if ($landingSiteType == 'custom')
                            <div>
                                ...
                                <x-input id="landingSiteUrl" class="block w-full mt-1" type="text"
            ...
            <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                <thead class="bg-gray-100 dark:bg-gray-700">
                    <tr>
                        ...
                        <th
                            class="px-4 py-3 text-xs font-medium text-right text-gray-500 uppercase dark:text-gray-400">
                            @lang('app.action')
                        </th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    @forelse ($customMenu as $menu)
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 even:bg-gray-50 dark:even:bg-gray-700">
                            <td class="px-4 py-3 text-base text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $menu->menu_name }}
                                <a href="{{ route('customMenu', $menu->menu_slug) }}" target="_blank" class="font-medium text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400">
                            ...
                            <td class="px-4 py-3 space-x-2 text-right whitespace-nowrap">
                                ...
                                <button type="button"
                                    class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition duration-150 ease-in-out bg-red-600 border border-transparent rounded-md hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                    ...
                    @empty
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="px-4 py-3 space-x-6 dark:text-gray-400" colspan="4">
