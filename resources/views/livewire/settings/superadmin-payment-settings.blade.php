            ...
            <ul class="flex flex-wrap -mb-px items-center">
                ...
                <li wire:click="activeSetting('paystack')" class="me-2">
                    <span @class(["inline-flex items-center gap-x-1 cursor-pointer select-none p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300", 'border-transparent' => ($activePaymentSetting != 'paystack'), 'active border-skin-base dark:text-skin-base dark:border-skin-base text-skin-base' => ($activePaymentSetting == 'paystack')])>
                        <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="#0AA5FF">
                ...
                <div class="grid gap-6">
                    ...
                    @if ($paystackStatus)
                        <div>
                            ...
                            <x-select id="selectPaystackEnvironment" class="mt-1 block w-full" wire:model.live="selectPaystackEnvironment">
                                <option value="test">@lang('app.test')</option>
                                <option value="live">@lang('app.live')</option>
                            </x-select>
                        ...
                        @if ($selectPaystackEnvironment == 'live')
                            <div class="grid grid-cols-2 gap-x-4">
                                <div>
                                    ...
                                    <x-input id="paystackKey" class="block mt-1 w-full" type="text" wire:model='paystackKey'/>
                                    <x-input-error for="paystackKey" class="mt-2"/>
                                </div>
        
                                <div>
                                    <x-label for="paystackSecret" value="Paystack SECRET" required/>
                                    <x-input-password id="paystackSecret" class="block mt-1 w-full" type="text" wire:model='paystackSecret'/>
                            ...
                            <div class="grid grid-cols-2 gap-x-4">
                                <div>
                                    ...
                                    <x-input id="paystackMerchantEmail" class="block mt-1 w-full" type="text" wire:model='paystackMerchantEmail'/>
                        ...
                        @else
                            <div class="grid grid-cols-2 gap-x-4">
                                <div>
                                    ...
                                    <x-input id="testPaystackKey" class="block mt-1 w-full" type="text" wire:model='testPaystackKey'/>
                                    <x-input-error for="testPaystackKey" class="mt-2"/>
                                </div>

                                <div>
                                    <x-label for="testPaystackSecret" value="Test Paystack SECRET" required/>
                                    <x-input-password id="testPaystackSecret" class="block mt-1 w-full" type="text" wire:model='testPaystackSecret'/>
                            ...
                            <div class="grid grid-cols-2 gap-x-4">
                                <div>
                                    ...
                                    <x-input id="testPaystackMerchantEmail" class="block mt-1 w-full" type="text" wire:model='testPaystackMerchantEmail'/>
                ...
                <div class="grid gap-6">
                    ...
                    @if ($paypalStatus)
                        <div>
                            ...
                            <x-select id="selectPaypalEnvironment" class="mt-1 block w-full" wire:model.live="selectPaypalEnvironment">
                                <option value="test">@lang('app.test')</option>
                                <option value="live">@lang('app.live')</option>
                            </x-select>
                        ...
                        @if ($selectPaypalEnvironment == 'live')
                            <div class="grid grid-cols-2 gap-x-4">
                                <div>
                                    ...
                                    <x-input id="paypalClientId" class="block mt-1 w-full" type="text" wire:model='paypalClientId'/>
                                    <x-input-error for="paypalClientId" class="mt-2"/>
                                </div>
        
                                <div>
                                    <x-label for="paypalSecret" value="Paypal SECRET" required/>
                                    <x-input-password id="paypalSecret" class="block mt-1 w-full" type="text" wire:model='paypalSecret'/>
                        ...
                        @else
                            <div class="grid grid-cols-2 gap-x-4">
                                <div>
                                    ...
                                    <x-input id="testPaypalClientId" class="block mt-1 w-full" type="text" wire:model='testPaypalClientId'/>
                                    <x-input-error for="testPaypalClientId" class="mt-2"/>
                                </div>

                                <div>
                                    <x-label for="testPaypalSecret" value="Test Paypal Secret" required/>
                                    <x-input-password id="testPaypalSecret" class="block mt-1 w-full" type="text" wire:model='testPaypalSecret'/>
                ...
                <div class="grid gap-6">
                    ...
                    @if ($payfastStatus)
                        <div>
                            ...
                            <x-select id="selectPayfastEnvironment" class="mt-1 block w-full" wire:model.live="selectPayfastEnvironment">
                        ...
                        @if ($selectPayfastEnvironment == 'live')
                            <div class="grid grid-cols-2 gap-x-4">
                                <div>
                                    ...
                                    <x-input id="payfastMerchantId" class="block mt-1 w-full" type="text" wire:model='payfastMerchantId'/>
                                    <x-input-error for="payfastMerchantId" class="mt-2"/>
                                </div>

                                <div>
                                    <x-label for="payfastMerchantKey" value="Payfast Merchant Key" required/>
                                    <x-input id="payfastMerchantKey" class="block mt-1 w-full" type="text" wire:model='payfastMerchantKey'/>
                                    <x-input-error for="payfastMerchantKey" class="mt-2"/>
                                </div>

                                <div class="col-span-2 mt-4">
                                    <x-label for="payfastPassphrase" value="Payfast Passphrase" required/>
                                    <x-input id="payfastPassphrase" class="block mt-1 w-full" type="text" wire:model='payfastPassphrase'/>
                        ...
                        @else
                            <div class="grid grid-cols-2 gap-x-4">
                                <div>
                                    ...
                                    <x-input id="testPayfastMerchantId" class="block mt-1 w-full" type="text" wire:model='testPayfastMerchantId'/>
                                ...
                                <div>
                                    ...
                                    <x-input id="testPayfastMerchantKey" class="block mt-1 w-full" type="text" wire:model='testPayfastMerchantKey'/>
                                ...
                                <div class="col-span-2 mt-4">
                                    ...
                                    <x-input id="testPayfastPassphrase" class="block mt-1 w-full" type="text" wire:model='testPayfastPassphrase'/>
