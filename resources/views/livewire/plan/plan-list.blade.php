<div>
    ...
    @if(!$free)
        @if($stripeSettings->razorpay_status == 1 || $stripeSettings->stripe_status == 1 || $stripeSettings->flutterwave_status == 1 || $stripeSettings->paystack_status == 1|| $stripeSettings->paypal_status == 1 || $stripeSettings->payfast_status == 1)
            @push('scripts')
