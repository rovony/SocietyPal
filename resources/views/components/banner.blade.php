@props(['style' => session('flash.bannerStyle', 'success'), 'message' => session('flash.banner'), 'link' => session('flash.link', null)])

<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message, 'link' => $link]) }}"
