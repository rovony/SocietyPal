                    ...
                    <div class="space-y-6 sm:space-y-8">
                      ...
                      <ul class="space-y-2 sm:space-y-4">
                        <li class="flex gap-x-3 items-center">
                          <span class="size-4 flex justify-center items-center rounded-full bg-rose-of-sharon-600 text-rose-of-sharon-50 dark:bg-rose-of-sharon-800/30 dark:text-rose-of-sharon-500 dark:text-white">
