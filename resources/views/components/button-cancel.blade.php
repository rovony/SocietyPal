<button type="button" {{ $attributes->merge(['type' => 'button', 'class' => 'inline-flex justify-center text-gray-500
    items-center bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border
