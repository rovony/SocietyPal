    ...
    <div class="bg-white dark:bg-gray-700 shadow-md border dark:border-gray-600 rounded-lg">
        ...
        <div class="border-b border-gray-200 dark:border-gray-600 px-6 py-2.5 flex items-center justify-between">
            ...
            <x-dropdown align="right">
                ...
                <x-slot name="content">
                    <x-dropdown-link wire:click="cancelSubscription(true)" class="cursor-pointer text-red-600 dark:text-red-400">
                        @lang('modules.billing.cancelImmediately')
                    </x-dropdown-link>
                    <x-dropdown-link wire:click="cancelSubscription" class="cursor-pointer text-yellow-500 dark:text-yellow-400">
