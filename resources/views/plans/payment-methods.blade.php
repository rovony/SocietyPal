    ...
    @if($showOnline && $paymentGatewayActive)
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 space-y-4 items-baseline">
            ...
            @if($stripeSettings->paystack_status === 1)
                <button wire:click="initiatePaystackPayment({{ $selectedPlan?->id }});" class="btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 border rounded f-15 btn px-4 py-3 w-full flex items-center">
            ...
            @if($stripeSettings->paypal_status === 1)
                <button wire:click="initiatePaypalPayment({{ $selectedPlan?->id }});" class="btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 border rounded f-15 btn px-4 py-3 w-full flex items-center">
            ...
            @if($stripeSettings->payfast_status === 1)
                <button wire:click="initiatePayfastPayment({{ $selectedPlan?->id }});" class="btn-light hover:shadow hover:bg-indigo-50 dark:hover:bg-gray-500 border rounded f-15 btn px-4 py-3 w-full flex items-center">
