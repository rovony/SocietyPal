    ...
    <div>
        <x-dropdown align="left" dropdownClasses="z-10">
            ...
            <x-slot name="content">
                ...
                <x-dropdown-link wire:key='status-completed' onclick="event.stopPropagation()">
                    <input id="status-completed" type="checkbox" value="completed" wire:model.live='filterStatus'
                    ...
                    <label for="status-completed" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        @lang('modules.assets.completed')
                    </label>
                </x-dropdown-link>
                ...
                <x-dropdown-link wire:key='status-overdue' onclick="event.stopPropagation()">
                    <input id="status-overdue" type="checkbox" value="overdue" wire:model.live='filterStatus'
                        class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 rounded focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                    <label for="status-overdue" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        @lang('modules.assets.overdue')
                    </label>
                </x-dropdown-link>
