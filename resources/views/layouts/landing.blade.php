...
<body class="font-sans antialiased dark:bg-gray-900">
    <div class="max-w-lg mx-auto shadow-md lg:max-w-screen-xl min-h-svh lg:shadow-none">
            ...
            <nav class="bg-white border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:text-gray">
                <div class="flex flex-wrap items-center justify-between mx-auto">
                    <a href="{{ url('/') }}" class="flex items-center gap-1 app-logo">
                        <img src="{{ global_setting()->logoUrl }}" class="h-6 ltr:mr-3 rtl:ml-3 sm:h-9"
                            alt="App Logo" />
                    ...
                    <div class="items-center justify-between hidden w-full mt-4 rounded-md bg-gray-50 dark:bg-gray-700"
                        id="mobile-menu-2">
                        <ul class="flex flex-col font-medium ">
                            <li>
                                <a href="{{ url('/') }}" wire:navigate
                                    class="block py-2 pl-3 pr-4 text-gray-700 rounded dark:text-white">@lang('menu.home')</a>
                            </li>

                            <li>
                                <a href="{{ url('/') }}#icon-features" wire:navigate
                                    class="block py-2 pl-3 pr-4 text-gray-700 rounded dark:text-white">@lang('landing.features')</a>
                            </li>

                            <li>
                                <a href="{{ url('/') }}#simple-pricing" wire:navigate
                                    class="block py-2 pl-3 pr-4 text-gray-700 rounded dark:text-white">@lang('landing.pricing')</a>
                            </li>

                            @php
                                $customMenu = App\Models\CustomWebPage::all();
                            @endphp
                            ...
                            <li>
                                <a href="{{ route('login') }}" wire:navigate
                                    class="block py-2 pl-3 pr-4 text-gray-700 rounded dark:text-white">
                                    @if (user())
                                        @lang('menu.dashboard')
                                    @else
                                        @lang('app.login')
                            ...
                            <li>
                                <a href="{{ route('society_signup') }}" wire:navigate
                                    class="block py-2 pl-3 pr-4 text-gray-700 rounded dark:text-white">@lang('landing.getStarted')</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <header class="sticky inset-x-0 top-0 z-50 hidden lg:block">
                ...
                <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
                    ...
                    <div class="flex items-center lg:order-2">
                        ...
                        <div id="tooltip-toggle" role="tooltip"
                            class="absolute z-10 invisible hidden px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip">
                            Toggle dark mode
                            <div class="tooltip-arrow" data-popper-arrow></div>
                        </div>

                        <a href="{{ route('login') }}"
                            class="inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-25"
    ...
    @stack('modals')
    <footer class="p-4 bg-white border-t sm:p-6 dark:bg-gray-800 ">
