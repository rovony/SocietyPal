        ...
        <x-dropdown align="left" dropdownClasses="z-10">
            <x-slot name="trigger">
                <span class="inline-flex rounded-md">
                    <button type="button"
                        ...
                        <div class="inline-flex items-center justify-center w-5 h-5 text-xs font-medium text-white bg-red-500  rounded-md  dark:border-gray-900 ml-1 {{ count($filterStatuses) == 0 ? 'hidden' : '' }}">{{ count($filterStatuses) }}</div>
            ...
            <x-slot name="content">
                ...
                <x-dropdown-link wire:key='status-active' onclick="event.stopPropagation()">
                    <input id="status-active" type="checkbox" value="active" wire:model.live='filterStatuses'
                ...
                <x-dropdown-link wire:key='status-inactive' onclick="event.stopPropagation()">
                    <input id="status-inactive" type="checkbox" value="inactive" wire:model.live='filterStatuses'
                        class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-gray-600 focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
