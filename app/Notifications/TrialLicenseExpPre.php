...
class TrialLicenseExpPre extends BaseNotification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return $build
            ...
            ->line(__('email.trialLicenseExpPre.line1', ['date' => \Carbon\Carbon::parse($this->society->trial_ends_at)->format('d F, Y')]))
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => __('email.trialLicenseExpPre.subject') . ' - ' . $siteName . '!',
