...
class EditGlobalCurrency extends Component
{
    ...
    {
        $this->societyCurrency = $this->currency->currency_name;
    ...
    public function submitForm()
    {
        ...
        $this->currency->currency_name = $this->societyCurrency;
    ...
    {
        return view('livewire.forms.superadmin.edit-global-currency', [
