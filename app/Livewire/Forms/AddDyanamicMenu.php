...
class AddDyanamicMenu extends Component
{
    ...
    {
        $this->validate([
        'menuName' => 'required|string|max:255|unique:custom_web_pages,menu_name',
        'menuSlug' => 'required|string|max:255|unique:custom_web_pages,menu_slug',
        ...
        $this->dispatch('closeAddDynamicMenu');
    }
