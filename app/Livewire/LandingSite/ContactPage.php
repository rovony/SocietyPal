...
class ContactPage extends Component
{
    ...
    public function loadLanguageContents()
    {
        ...
        $this->existingImageUrl = ($contacts && $contacts->image) ? $contacts->image_url : null;
    }
    ...
    public function saveContact()
    {
        $this->validate([
            ...
            'contactImage' => $this->existingImageUrl ? '' : 'required|image|mimes:jpeg,png,jpg,gif|max:2048'
        ]);
